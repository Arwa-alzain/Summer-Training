<?php
// htdocs/task3/askbot.php
header('Content-Type: application/json; charset=utf-8');

// إظهار أخطاء PHP للتتبع
ini_set('display_errors', 0);
error_reporting(E_ALL);

// استدعي config.php المباشر من نفس المجلد
...
if (!defined('GEMINI_API_KEY') || empty(GEMINI_API_KEY)) {
    ...
    echo json_encode(['error' => 'لم يتم ضبط مفتاح Gemini API في config.php']);
    exit;
}
...
curl_setopt_array($ch, [
    ...
    CURLOPT_TIMEOUT        => 25,
    // خيارات حل مشكلة SSL على استضافة InfinityFree
